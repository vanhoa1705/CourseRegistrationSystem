...
public class CreateMonHoc extends javax.swing.JFrame {

    /**
     * Creates new form CreateMonHoc
     */
    public CreateMonHoc() {
        initComponents();
    }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        int result = MonHocDAO.createMonHoc(txtCode.getText(), txtName.getText(), temp);
        if(result > 0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateMonHoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateMonHoc().setVisible(true);
            }
        });
    }
