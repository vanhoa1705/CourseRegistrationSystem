 ...
 * @author HoaNguyen
 */
public class DanhSachHocPhanDangKi extends javax.swing.JFrame {

    /**
     * Creates new form DanhSachHocPhanDangKi
     */
    public DanhSachHocPhanDangKi() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DanhSachHocPhanDangKi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DanhSachHocPhanDangKi().setVisible(true);
            }
        });
    }
